...
class _DepartureVerificationScreenState extends State<DepartureVerificationScreen> {
  ...
  @override
  void dispose() {
    LoggingService().debug('Disposing DepartureVerificationScreen resources');
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              child: StreamBuilder<List<ClearanceApplication>>(
                // Stream to fetch the list of departure applications
                stream: repo.streamApplications(type: 'departure'),
