...
const Map<String, Map<String, Map<String, String>>> localizedStringsData = {
    'EN': {
      ...
      'privacySecurity': {
        ...
        'contact_body':
            'Reach your administrator or email support@isam-clearance.id for assistance.',
      },
    ...
    'ID': {
      ...
      'privacySecurity': {
        ...
        'contact_body':
            'Hubungi administrator Anda atau kirim email ke support@isam-clearance.id untuk bantuan.',
      },
